...
export default function Home() {
  return (
    <div className="container">
      <Head>
        <title>GSoC: How does the whole thing work!</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main>
      <Layout>
      <h1 className={utilStyles.heading2Xl}><span className={utilStyles.font}>{'GSoC: How does the whole thing work!'}</span></h1>
